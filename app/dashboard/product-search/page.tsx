  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="flex max-w-full">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-end justify-center gap-8 mb-8">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <Card className="w-64 transform hover:scale-105 transition-transform">
                          <CardContent className="p-6 text-center">
                            <div
                              className="w-16 h-16 bg-white rounded-full shadow-md border-2 border-blue-200 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform mx-auto mb-4"
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <Card className="w-72 transform hover:scale-105 transition-transform ring-2 ring-blue-200 shadow-lg">
                          <CardContent className="p-8 text-center">
                            <div
                              className="w-20 h-20 bg-white rounded-full shadow-lg border-2 border-blue-300 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform mx-auto mb-4"
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <Card className="w-60 transform hover:scale-105 transition-transform">
                          <CardContent className="p-5 text-center">
                            <div
                              className="w-14 h-14 bg-white rounded-full shadow-md border-2 border-blue-200 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform mx-auto mb-4"
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b-2 border-slate-200">
                            ...
                            <th className="text-left py-3 px-2 font-medium">Deployment</th>
                            ...
                            >
                              ...
                              <td className="py-4 px-2">
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span className="text-xs">{product.deployment}</span>
                                </div>
                                <div className="flex items-center space-x-1 mt-1">
                                  <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                                  <span className="text-xs">Multi-region</span>
                                </div>
                              ...
                              <td className="py-4 px-2">
                                ...
                                <div className="flex items-center space-x-1 mt-1">
                                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                                  <span className="text-xs">85% cloud adoption</span>
                                </div>
                              </td>
                              <td className="py-4 px-2">
        ...
        <div className="fixed right-0 top-0 h-full w-72 border-l bg-white dark:bg-card">
